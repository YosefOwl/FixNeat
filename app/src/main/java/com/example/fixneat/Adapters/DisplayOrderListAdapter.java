...
public class DisplayOrderListAdapter extends BaseExpandableListAdapter {

    private Context context;
    private Map<String, List<String>> orderCollection;
    ...
    public int getChildrenCount(int i) {
        return orderCollection.get(groupList.get(i)).size();
    }
    ...
    public Object getChild(int i, int i1) {
        return orderCollection.get(groupList.get(i)).get(i1);
    }
    ...
    public View getChildView(final int i, final int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        TextView item = view.findViewById(R.id.order_details_TV);
        item.setText(model);
...
//                        List<String> child = orderCollection.get(groupList.get(i));
//                        child.remove(i1);
